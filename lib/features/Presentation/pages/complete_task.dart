...
class _CompleteTaskPageState extends State<CompleteTaskPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(body: BlocBuilder<TaskCubit, TaskState>(
      builder: (context, taskState) {
        if (taskState is TaskLoadedState) {
          final completeTasks = taskState.taskdata
    ...
    return Container(
      ...
      child: GestureDetector(
        onTap: () {
          AwesomeDialog(
            context: context,
            borderSide: BorderSide(color: taskTypeColor[0], width: 2),
            width: 280,
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                        color: taskTypeColor[task.colorIndex],
